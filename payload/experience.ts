      ...
      positions: [
        {
          ...
          descriptions: [
            ...
            '타켓 이커머스 대형 프로모션 기간 큐 적체로 인한 지연을 해소하기 위해 Celery 워커를 큐 길이 기반 오토스케일링으로 변경, 급격한 트래픽 변화에도 안정적 처리율을 확보',
      ...
      positions: [
        {
          ...
          descriptions: [
            ...
            'FCM 대량 푸시 요청 시 병목 현상을 Celery 워커 풀링으로 개선, 피크 트래픽에도 안정적 전송률 유지',
          ],
          skillKeywords: [
            'Python',
            'FastAPI',
