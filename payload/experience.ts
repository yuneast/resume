      ...
      positions: [
        {
          ...
          skillKeywords: ['PHP', 'Java', 'Kotlin', 'Spring Boot', 'Spring Security', 'JPA', 'MySQL', 'Redis', 'Docker', 'AWS'],
        },
      ],
    },
    {
      ...
      positions: [
        {
          ...
          skillKeywords: ['Python', 'FastAPI', 'Next.js', 'PostgreSQL', 'Redis', 'Celery', 'FCM', 'Docker', 'SSE'],
        },
      ],
    },
    {
