...
- [ ] 각 프로젝트가 구조화되어 한눈에 들어오는가?
- [ ] 문제 상황과 해결 과정이 포함되어 있는가?
- [ ] Git/블로그 링크가 포함되어 있는가?
- [ ] 주체적인 역할과 기여가 명확한가?
- [ ] 협업과 커뮤니케이션 경험이 드러나는가?
- [ ] 트래픽 규모나 도메인 경험이 명시되어 있는가?
- [ ] 재직기간이 1년 미만이라면 장기 프로젝트 경험을 보완했는가?
- [ ] 기본 기술 스택에 대한 깊이가 드러나는가?
- [ ] 긍정적이고 적극적인 태도가 느껴지는가?
- [ ] 지원 포지션과 관계없는 내용은 제거했는가?
